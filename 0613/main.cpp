...
void display()
{
    ...
    glPushMatrix();
        ...
        glPushMatrix();///右手
            ...
            glRotatef(angle[12],0,0,1);///往旁邊張開
            glRotatef(angle[11],1,0,0);///往頭腳移動
            glRotatef(angle[10],0,1,0);///手不移動旋轉
...
int main(int argc, char*argv[])
{
    ...
    id1 = id2("data/background.jpg");
    id2 = id2("data/Diffuse.jpg");
